...
AUTH_THROTTLE_WINDOW_SECONDS = env_int("AUTH_THROTTLE_WINDOW_SECONDS", 300)
AUTH_REGISTER_MAX_ATTEMPTS = env_int("AUTH_REGISTER_MAX_ATTEMPTS", 5)
AUTH_LOGIN_MAX_ATTEMPTS = env_int("AUTH_LOGIN_MAX_ATTEMPTS", 10)
